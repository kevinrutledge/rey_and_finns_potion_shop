    ...
    try:
        with db.engine.begin() as connection:
            ...
            create_tables_query = """
                ...
                -- Customers Table (References Customer Visits)
                CREATE TABLE customers (
                    customer_id BIGSERIAL PRIMARY KEY,
                    visit_id BIGINT REFERENCES customer_visits(visit_id) ON DELETE CASCADE,
                ...
                CREATE TABLE cart_items (
                    ...
                    potion_id INT REFERENCES potions(potion_id) ON DELETE CASCADE,
